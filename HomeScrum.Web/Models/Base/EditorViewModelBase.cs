...
namespace HomeScrum.Web.Models.Base
{
   ...
   // of editor view model based on the type for our model.
   //   var model = new ModelT();
   //   var viewModel = Mapper.Map( model, model.GetType(), typeof( EditorViewModelBase ) ); 
   public class EditorViewModelBase
   {
