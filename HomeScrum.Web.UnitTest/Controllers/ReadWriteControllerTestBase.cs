...
namespace HomeScrum.Web.UnitTest.Controllers
{
      ...
      where EditorViewModelT : DomainObjectViewModel, IEditorViewModel, new()
   {
      ...
      public void CreateGet_AddsCallingActionAndId_IfSpecified()
      {
         ...
         var viewModel = ((PartialViewResult)controller.Create( callingAction: "Edit", callingId: parentId.ToString() )).Model as ViewModelBase;
      ...
      public void CreateGet_PushesToNavigationStack_IfCallingDataGiven()
      {
         ...
         var viewModel = ((PartialViewResult)controller.Create( callingController: "BlueJackets", callingAction: "Edit", callingId: parentId.ToString() )).Model as ViewModelBase;
      ...
      public void CreateGet_SetsModeToCreate()
      {
         ...
         var viewModel = ((PartialViewResult)controller.Create( callingAction: "Edit", callingId: parentId.ToString() )).Model as IEditorViewModel;
      ...
      public void EditGet_PushesToNavigationStack_IfCallingDataGiven()
      {
         ...
         var viewModel = ((PartialViewResult)controller.Edit( id, callingController: "Icing", callingAction: "Edit", callingId: parentId.ToString() )).Model as ViewModelBase;
      ...
      public void EditGet_SetsModeToEdit()
      {
         ...
         var viewModel = ((PartialViewResult)controller.Edit( id, callingAction: "Edit", callingId: parentId.ToString() )).Model as IEditorViewModel;
